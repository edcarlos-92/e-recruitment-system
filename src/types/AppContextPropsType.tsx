...
import { LanguageProps } from "../@mactech/core/AppLngSwitcher/data";
...
interface EdadminPalette extends Palette {
  background: {
    paper: string;
    default: string;
  };
...
export interface EdadminTheme extends Theme {
  direction: Direction;
  cardRadius: number;
  palette: EdadminPalette;
  status: {
    danger: string;
  };
  divider: string;
